...
public:
    ...
    tsl::elm::Element* createUI() override {
        ...
        list->addItem(config_noncasigchk1.create_list_item("关闭NCA签名验证_10.0.0-16.1.0"));
        list->addItem(config_noncasigchk2.create_list_item("关闭NCA签名验证_17.0.0+"));
        list->addItem(config_nocntchk1.create_list_item("关闭CNT验证_10.0.0-18.1.0"));
        list->addItem(config_nocntchk2.create_list_item("关闭CNT验证_19.0.0-20.5.0"));
        list->addItem(config_nocntchk3.create_list_item("关闭CNT验证_21.0.0+"));

        list->addItem(new tsl::elm::CategoryHeader("加载器(LDR) - 0100000000000001"));
        list->addItem(config_noacidsigchk3.create_list_item("关闭ACID签名验证_10.0.0+"));
        ...
        list->addItem(config_es4.create_list_item("加密服务_19.0.0+"));
        ...
        list->addItem(config_nim_fw3.create_list_item("锁定固件更新_7.0.0-11.0.1"));
        list->addItem(config_nim_fw4.create_list_item("锁定固件更新_12.0.0+"));
