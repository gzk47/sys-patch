...
constinit Patterns fs_patterns[] = {
    ...
    { "关闭新版NCA签名验证", "0x.94..0036.258052", 2, 0, tbz_cond, nop_patch, nop_applied, true, MAKEHOSVERSION(17,0,0), FW_VER_ANY }, // 17.0.0 - 19.0.0+
...
constinit Patterns ldr_patterns[] = {
    { "关闭ACID签名验证", "0xFD7B.A8C0035FD6", 16, 2, subs_cond, subs_patch, subs_applied, true, FW_VER_ANY },
};
...
constinit Patterns nim_patterns[] = {
    { "网络安装管理(nim)", "0x.0F00351F2003D5", 8, 0, adr_cond, mov2_patch, mov2_applied, true, MAKEHOSVERSION(17,0,0), FW_VER_ANY },
};
